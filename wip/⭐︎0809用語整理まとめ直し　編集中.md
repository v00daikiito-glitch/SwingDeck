...
※ その週に確定日が1つも無い間（例：月曜早朝、市場が開く前）は、この行自体を作らない。前の週の`is_closed:1`の行が、そのまま「最新」として残る
...
※ その月に確定日が1つも無い間（例：月初日の早朝、市場が開く前）は、この行自体を作らない。前の月の`is_closed:1`の行が、そのまま「最新」として残る
